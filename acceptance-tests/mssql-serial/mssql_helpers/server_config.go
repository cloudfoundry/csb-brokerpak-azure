...
func (d DatabaseServerPair) ReconfigureCSBWithServerDetails(broker string) {
	helpers.SetBrokerEnv(
		broker, helpers.EnvVar{Name: "MSSQL_DB_FOG_SERVER_PAIR_CREDS", Value: d.ServerPairsConfig()},
	)
